'''
    ...
    nif, y el descuento que se le aplica. Las líneas se separan con el carácter de cambio
    ...
    otro diccionario con el resto de la información del cliente. Los diccionarios
    con la información de cada cliente tendrán como claves los nombres de los campos
...
# yo lo intente hacer, pero no pude.

print("solucion segun el ejercicio en linea ")
# Cadena con los resultados de los clientes de la empresa
...
for i in lista_clientes[1:]:
    # Inicializamos el diccionario que va a contener los resultados del cliente actual a vacío.
    cliente = {}
    ...
    # el diccionario que acabamos de crear con el resto de sus resultados.
